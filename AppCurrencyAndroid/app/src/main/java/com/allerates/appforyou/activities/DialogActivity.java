...
public class DialogActivity extends ListActivity {
    ...
    @BindString(R.string.txt_got_error)
    String txtGotError;
    @BindString(R.string.txt_number_check)
    String txtNumberCheck;
    @BindString(R.string.txt_is_first_button)
    String txtIsFirstButton;
    @BindString(R.string.txt_invalid_value)
    String txtInvalidValue;
    @BindString(R.string.txt_error)
    String txtError;
    ...
    private void popPayMethList(String[] array) {
        payMetList = new ArrayList<>();
        payMetList.clear();
        for (String s : array) payMetList.add(new Data(s));
    }
    ...
    public class Currency {
        ...
        Currency(String name, Drawable flag) {
            this.name = name;
            this.flag = flag;
        }
