...
public class ArticleForValue {
     ...
     */
        ...
        public ArticleForValue() {
        }

        public ArticleForValue(String title, String genre, String year, String from, String to, String courseValue) {
            this.from = from;
